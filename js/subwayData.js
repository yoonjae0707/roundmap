...
export const stations = {
  ...
  'cheongnyangni': {
    ...
    accessible: {
      ...
      'K': { hasElevator: true, hasWheelchairLift: false, accessibleRoute: 'KTX 역사 엘리베이터 -> 지상 1층 경의중앙선 승강장 직통 수직기 탑승' }
    }
  },
  'dongdaemun': {
    ...
    accessible: {
      ...
      '4': { hasElevator: true, hasWheelchairLift: false, accessibleRoute: '10번 출구 엘리베이터 -> 4호선 대합실 -> 4호선 승강장 연계 리프트 완비' }
    }
  },
  'jongno3': {
  ...
  'gasan': {
    ...
    facilities: {
      ...
      '7': { toilet: '지하 1층 7호선 대합실 내부', nursing: '7호선 안내실 내부', locker: '6번 출구 대합실', elevatorLocation: '5번, 6번 출구 외부' }
    },
    accessible: {
  ...
  'sinchon': {
    ...
    accessible: { '2': { hasElevator: true, hasWheelchairLift: false, accessibleRoute: '1번 출구 엘리베이터 -> 지하 대합실 -> 2호선 승강장 리프트 탑승' } }
  },
  'chungjeongro': {
  ...
  'wangsimni': {
    ...
    facilities: {
      ...
      'B': { toilet: '지상 2층 맞이방 내부', nursing: '코레일 고객안내실 내 수유방', locker: '비트플렉스 지하 1층 연결로', elevatorLocation: '민자역사 내부' },
  ...
  'gangnam': {
    ...
    facilities: {
      ...
      'S': { toilet: '신분당선 지하 개찰구 내부 B1층', nursing: '신분당선 고객서비스센터 내 수유방', locker: '신분당선 환승통로', elevatorLocation: '1번, 4번 출구 외부' }
    },
    accessible: {
      '2': { hasElevator: true, hasWheelchairLift: false, accessibleRoute: '12번 출구 엘리베이터 -> 지하 대합실 -> 2호선 승강장 리프트 탑승' },
  ...
  'anguk': {
    ...
    facilities: { '3': { toilet: '지하 1층 대합실 개찰구 밖', nursing: '없음', locker: '1번, 4번 출구 앞', elevatorLocation: '5번 출구 앞 외부 엘리베이터' } },
  ...
  'ogeum': {
    ...
    accessible: {
      '3': { hasElevator: true, hasWheelchairLift: false, accessibleRoute: '1번 출구 엘리베이터 -> 지하 대합실 -> 3호선 승강장 직접 연결' },
...
export const links = [
  ...
  { source: 'gwanghwamun', target: 'jongno3', line: '5', weight: 2, accessible: false }, // 종로3가 주변 휠체어 리프트 구간
...
// 환승역 탭 분리 제어 및 도보 환승 소요 시간 자동 수동 매핑 생성자
